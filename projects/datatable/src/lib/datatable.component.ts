        ...
        if (flr.id === 'Menu') {
          ...
          if (this.pageName == 'Audit') {
            for (let i = 0; i < this.moduleArr.length; i++) {
              console.log(this.moduleArr[i].menuId, this.moduleArr[i].menuName);
              if (this.moduleArr[i] != undefined && this.moduleArr[i].menuId == 9) {
                this.moduleArr.splice(i, 1);
                --i;
              }
              if (this.moduleArr[i] != undefined && this.moduleArr[i].menuId == 18) {
                this.moduleArr.splice(i, 1);
                --i;
              }
              if (this.moduleArr[i] != undefined && (this.moduleArr[i].menuId == 30 || this.moduleArr[i].menuId == 31 || this.moduleArr[i].menuId == 32 || this.moduleArr[i].menuId == 27 || this.moduleArr[i].menuId == 16 || this.moduleArr[i].menuId == 22 || this.moduleArr[i].menuId == 25)) {
                this.moduleArr.splice(i, 1);
                --i;
              }
            }
          ...
          if (this.pageName == 'Favorite') {
            for (let i = 0; i < this.moduleArr.length; i++) {
              if ((this.moduleArr[i] != undefined && this.moduleArr[i].menuId == 9) || (this.moduleArr[i] != undefined && this.moduleArr[i].menuId == 1)) {
                this.moduleArr.splice(i, 1);
                --i;
              }
              if (this.moduleArr[i] != undefined && this.moduleArr[i].menuId == 18) {
              ...
              if (this.moduleArr[i] != undefined &&
                (this.moduleArr[i].menuId == 29 || this.moduleArr[i].menuId == 30 || this.moduleArr[i].menuId == 31 || this.moduleArr[i].menuId == 32 || this.moduleArr[i].menuId == 12 || this.moduleArr[i].menuId == 13 || this.moduleArr[i].menuId == 27 || this.moduleArr[i].menuId == 16 || this.moduleArr[i].menuId == 20 || this.moduleArr[i].menuId == 19 || this.moduleArr[i].menuId == 22 || this.moduleArr[i].menuId == 25 || this.moduleArr[i].menuId == 9 || this.moduleArr[i].menuId == 18)) {
                this.moduleArr.splice(i, 1);
                --i;
              }
            }
