        ...
        this.supportservice.getSupportService(`/api/support/${this.id}`).subscribe(res => {
          if (res.status.success === true) {
            ...
            this.supportForm.patchValue({
              ...
              "fileEdit": uploadArr,
              "ticketCreatedDate": this.customDatePipe.transform(customerSupport.ticketCreatedDate, 'MM/dd/yyyy'),
    ...
    this.studyList.forEach(element => {
      if (this.studyId === element.studyId) {
        ...
        this.supportForm.patchValue({
          ...
          'studyEndDate': this.studyDetails.startDate ? this.customDatePipe.transform(this.studyDetails.startDate, 'MM-dd-yyyy') : '',
          'studyStartDate': this.studyDetails.endDate ? this.customDatePipe.transform(this.studyDetails.endDate, 'MM-dd-yyyy') : '',
        })
      }  
    });
